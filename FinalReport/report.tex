...
% Use preprint (not final) so page numbers appear; final uses empty page style.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\columnwidth]{rating_dist.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{user_item_dist.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.9\columnwidth]{genre_dist.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{model_comparison_rating.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{model_comparison_topn.png}
...
\centering
\includegraphics[width=\linewidth]{metrics_scatter_mae_ndcg.png}
\caption{MAE vs.\ NDCG@10}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\columnwidth}
\centering
\includegraphics[width=\linewidth]{metrics_radar.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{training_mf_sgd.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{training_deep.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{training_als.png}
